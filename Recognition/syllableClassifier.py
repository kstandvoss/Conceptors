...
class syllableClassifier:
    ...
    def prepData(self, n_syllables, n_train, n_test, samples = None, SR = 20000, dsType = 'mean', mel_channels = 12, invCoeffOrder = False, winsize = 20, frames = 64, smoothLength = 5, polyOrder = 3, incDer = [True,True], nComp = 10, usePCA = False):
    ...
    def cLearning(self, gamma_pos, gamma_neg, N = 10, SR = 1.2, bias_scale = 1.0 , inp_scale = 0.2, conn = 1):
    ...
    def cTest(self):
        ...
        for syll_i, syllable in enumerate(self.testDataFinal):
