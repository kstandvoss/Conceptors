...
parser.add_argument('-interpolType',
        default = 'IIR',
        type = str,
...
parser.add_argument('-invCoeffOrder',
        default = False,
        type = bool,
...
parser.add_argument('-melFramesN',
        default = 64,
        type = int,
        help = 'Desired number of time bins for mfcc data (default = 64)'
        )
parser.add_argument('-smoothL',
        default = 4,
        type = int,
...
parser.add_argument('-incDer',
        default = [True,
            rue],
        type = list, help = 'List of 2 booleans indicating whether to include 1./2. derivative of mfcc data or not (default = [True,True])'
        )
...
parser.add_argument('-scriptsDir',
        default = None,
        type = str,
